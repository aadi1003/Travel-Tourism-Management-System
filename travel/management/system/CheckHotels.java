...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String[] text=new String[]{"JW Marriott","Hyatt Regency","The Taj","Sheraton Grand","Radisson Blue","Trident","The Ritz-Carlton","The Corinthians","Blue Diamond","The Orchid"};
        try{
            for(int i=0;i <= 9;i++){
