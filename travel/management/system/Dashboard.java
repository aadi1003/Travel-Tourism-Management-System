...
public class Dashboard extends JFrame implements ActionListener{
   ...
   JButton destinations,bookhotel,viewBookedHotel,payments,calculators,notepad,about,deletePersonalDetails;
  ...
  p1.add(icon);
   ...
   bookpackage.setFont(new Font("Tahoma",Font.PLAIN,20));
    ...
    viewBookedHotel.setFont(new Font("Tahoma",Font.PLAIN,20));
     ...
     p2.add(viewBookedHotel);
      ...
      destinations=new JButton("Customize Package");
    destinations.setBounds(0,500,300,50);
   destinations.setBackground(new Color(0,0,102));
    destinations.setForeground(Color.WHITE);
    destinations.setFont(new Font("Tahoma",Font.PLAIN,20));
     destinations.setMargin(new Insets(0,0,0,70)); 
   ...
   calculators.setBackground(new Color(0,0,102));
    ...
    add(image);
     ...
     text.setFont(new Font("Railways",Font.PLAIN,55));
     image.add(text);
